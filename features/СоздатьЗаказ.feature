...
Контекст:
  И я подключаю TestClient "Admin" логин "Администратор" пароль "123"
Сценарий:
    ...
    И в поле с именем 'Наименование' я ввожу текст 'Отус_Новый контрагент'
    ...
    И из выпадающего списка с именем "Покупатель" я выбираю по строке 'Отус'
