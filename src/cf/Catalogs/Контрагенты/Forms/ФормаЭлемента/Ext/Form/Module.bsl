...
Процедура ТипКонтрагентаПриИзменении(Элемент)
	Если Объект.ТипКонтрагента = ПредопределенноеЗначение("Перечисление.ЮридическоеФизическоеЛицо.ФизическоеЛицо") Тогда
		Элементы.ГруппаТипКонтрагента.ТекущаяСтраница = Элементы.ГруппаФиз;
	Иначе
		Элементы.ГруппаТипКонтрагента.ТекущаяСтраница = Элементы.ГруппаЮр;
	КонецЕсли;
КонецПроцедуры
